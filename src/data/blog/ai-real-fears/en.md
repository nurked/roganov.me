...
*Hey everyone, 3 years later. I'm writing to you from the already distant year of 2024. I wrote this article a few months before ChatGPT became publicly available. Everything written here remains true and hasn't changed one bit, despite all the bloating of the AI space.*

A long time ago, in a far-far-away city of Kharkiv, I was 7 years old. That's when I first laid eyes on a miraculous new piece of technology — a VHS player. In my hands was my very first cassette tape. I didn't really care what I was about to watch. What mattered was the sheer fact that I'd get to watch something recorded. Oblivious to what fate had in store for me, I shoved a cassette with a hand-scrawled label reading "Terminator 2" into the player.

They say kids have wild imaginations. That children imagine things better than adults. I don't know why, but the scene I remember most vividly is Los Angeles getting bombed with nuclear warheads. I was in absolute panic, sitting quietly in front of the VCR, rewinding the tape to watch those terrifying frames over and over.

After I came to my senses, I started asking the adults about what I'd just seen — when it would happen and whose fault it would be. They scoffed and told me not to worry.
...
And come to think of it — how is it that a long time ago, in a galaxy far, far away, there was no artificial intelligence whatsoever, except for droids stuffed with gears? And in the distant future 20,000 years from now, if you believe Frank Herbert, creating artificial intelligence carries the death penalty.

But life goes on. Life is right here, right now. And people are quietly starting to lose it, because there's just too much of this AI stuff. And we can't seem to agree on what to do with it. Some say it needs to be eradicated, while Mark Zuckerberg declares there's nothing better than teaching AI to work even better.
...
In English there's a wonderful word "misnomer" — the wrong use of a word or name to describe something. Way back when the first vacuum tubes were warming up in ENIAC or UNIVAC, the American military folks who built those computers in 1945 decided to call their creations "electronic brains."

And that's where all hell broke loose. Nobody back then had the faintest clue how the brain actually works. Frankly, nobody can properly explain it even now. We have neurons, they weave together, and out comes you, Vasya Pupkin — the Russian equivalent of John Doe. Well, that's what we think. When you think, electricity runs through your brain. When you don't think, it doesn't. Here's the kicker — you store memories in your brain. But we don't know how. Probably something to do with neurons weaving together. If you count those neurons up, it turns out we can't figure out how we can remember anything at all. Oh, and here's another thing. Some people get flicked on the head and forget who they are. Others can have half their brain lopped off with an axe and they're totally fine.

No, seriously. Let's not pretend we fully understand how the brain works. "Understand" in the same way we understand how the heart works. We have 4 chambers. Blood enters here, flows from here to there, here's your systolic pressure, here's your diastolic. If things go really bad, we can install a pacemaker. We generally get how it works. But the commands to the heart come from the brain, and that part we're not touching. That's the part of the brain beyond human control. You can't control it. Unless you're some kind of Indian mystic. They can, but they get a pass on a lot of things.

Sure, we have neural interfaces, we can do MRI scans and remove tumors. We know that without a brain, our friend Vasya Pupkin is a goner. But we don't know how it actually works. Why? Because we don't know how to build a new one from scratch.

If we understand how a Soviet-era "Radiotekhnika" radio receiver works — a beloved piece of Soviet consumer electronics — we know the purpose of every component and can build a new one. We can fix it. We can build one on a transistor chip from China, on discrete transistors, or on warm, lovely vacuum tubes. That means we truly understand what a "Radiotekhnika" is and how it works.

The brain? Nope. We have hunches, but we're not sure. In 1945 we had no idea about 90% of the information we know about the brain today.
...
First, let's skip what's written in Wikipedia. That reads more like a horror descending on the wings of night.
...
So machine learning is simply adding data to a statistical model. What do you get at the output of your ML network? A float value ranging from 0 to 1. You're either looking at a dog — then it's .999 dog — or you're seeing a cat — that'll be .998 cat. Or, if the system is really confident, you might get a flat 1 dog. That's a 100% dog in the picture, I'd bet my teeth on it. Making these algorithms more sophisticated lets you create interesting things. For example, we can make a computer play Mario. Or stack Tetris pieces. Position 1 is 10% good, position 2 is 78% good.
...
Well, for the sake of completeness, let's look at "Neural Network":
...
Bottom line: we have an architecture where we connected processors in a certain way and can do "machine learning" on it.

Again, nothing described above implies the existence of a brain substitute or actual intelligence.

### So what are you complaining about, author?

About the fact that we love burning witches at the stake and playing Ghostbusters. Maybe because of all the science fiction, or maybe because we're missing something, we've started attributing human feelings to machines.

And I'm not talking about us trying to build a system that makes decisions about launching nuclear warheads. No. We haven't been that stupid.

Instead, we're doing other stupid things.

We've entrusted AI with our emotions and our ability to choose.
...
If Lyuda didn't like the joke about pink pants and the unicorn, a good storyteller will remember that Lyuda is a tough crowd, but she loves cats. So he'll pivot to cats. And things might just get back on track.

When the Algorithm suggests the next video for you to watch, it's not your best friend who can understand and forgive you. Its job isn't to make you feel better. Its job is to keep you on the site longer. And so your gaze lingers on some weird video, and the Algorithm has already made its judgment about what's good and what's bad. Three hours later, you find yourself in a swamp of bizarre videos about roadkill.

### Don't get me wrong

There's nothing inherently bad about AI. As long as you accept "it" for what "it" is. It's a computer algorithm. A sequence of actions for finding a result. In this case, the result won't be precisely defined, but that's the whole point of AI — to find the most probably correct result from the most probably correct dataset.
...
And then you've got your classic gun scenario. Put pistols in the hands of two people. The first is a seasoned fighter who's fired hundreds of different weapons. The second is some kid who knows nothing about guns but has watched gangster movies.

The first one will most likely put the safety on and tuck it away. The second one will shoot something. The first person knows what he did, what's in his hands, and how to use it. The first person is responsible for what he's holding. The second one will shoot the neighbor's cat and say: "It wasn't me, it went off by itself."

An even better analogy is cars. You've seen that seasoned driver who sits calmly in traffic. He knows that if he starts weaving around, he'll only waste time and gas. He knows how the car works and how traffic flows. His car is 10 years old, but there's not a scratch on it, and the engine runs like clockwork. It's always got fresh oil. And the battery terminals are polished to a shine.

On the other side, you've got your standard clueless driver who pours motor oil into the windshield washer reservoir.

The first person belongs to that strange, dying breed of professionals. People who can take responsibility for the results of their actions. The second breed is our self-taught programmers who watched a "How to Write Neural Networks in 3 Hours" course on YouTube.

The responsible programmer will sit down and use a neural network to restore blurred images. The second person will write a chatbot to cheer up themselves and their friends.
...
It makes them faster. Within a given dataset, a well-trained network can find the most correct answer far more efficiently than a person. Processing an array with more than a thousand parameters — that's something that would take our friend Vasya Pupkin 200 years of manual calculations.
...
But certain things are beyond AI's reach. The ability to suggest what I should watch after finishing all of Game of Thrones — I'd rather leave that to my friends. The answer to the question "What goes better with dark pants, a gray or white t-shirt?" — that's a question only three people in my life can answer.
...
Remember when I talked about professionals? My grandmother was an architect. She spent her whole life in front of a drafting board with a slide rule in her hand. She knew structural mechanics like I could only dream of. Whenever she walked into a fancy new building, she'd always critically examine the load-bearing structure, and several times in my presence she'd share her opinion. "This one will hold" or "Interesting solution, but they probably should've made it thicker."
...
People who fall short will make excuses for why they can't write code or hit a C-sharp in the third octave. And that's where neural networks and AI came to the rescue.
...
And the day isn't far off when we may stop taking responsibility for our own lives and hand them over to the Algorithm. You won't need any T-1000s or robot octopuses. Nobody's coming for you. You'll be invited. You'll find a glossy brochure in your hands explaining how living in the Meta universe is so much more convenient. They'll sell you on the idea that it doesn't matter what kind of house you have. You can just download the house the Algorithm suggests. After all, it knows best. And you don't anymore, because you've forgotten how to make decisions for yourself.
...
And then we can't make ends meet.
