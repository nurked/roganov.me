...
*Те книжки, из которых складывалось детство, — одна из причин, по которым я потом сделал [KidDOS](https://kiddos.dev/): маленький компьютер, который ребёнок может разобрать.*
