...
![Экран загрузки KidDOS 0.3.0: ЭЛТ-терминал, ребёнок печатает hi, машина спрашивает имя, а строка наставника пурпурным предлагает набрать help](/img/blog/kiddos-hi.png)
