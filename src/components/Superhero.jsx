...
export const Superhero = () => {
  ...
  return (
    <div id='superhero' className="min-h-screen bg-[#3FA2F6] text-white flex flex-col">
      ...
      <div className="flex-1 flex justify-between items-center p-4 sm:p-4 md:p-8">
        <div className="flex w-full gap-4">
          <Card imageSrc={image} description={description} className="w-full sm:w-1/2 min-h-[300px] lg:h-[500px] h-auto overflow-hidden" />
          <Card imageSrc={image2} description={description2} className="w-full sm:w-1/2 min-h-[300px] lg:h-[500px] h-auto overflow-hidden" />
        </div>
      </div>
      ...
      <div className="p-4 sm:p-6 md:p-8 flex-1 flex justify-center items-center bg-[#3F72AF]">
        <Card imageSrc={image3} description={description3} className="w-full min-h-[300px] lg:h-[500px] max-h-full overflow-auto" />
      </div>
      
      {/* Bottom Section */}
      <div className="flex-1 flex justify-between items-center p-4 sm:p-4 md:p-8">
        <div className="flex w-full gap-4">
          <Card imageSrc={image4} description={description4} className="w-full sm:w-1/2 min-h-[300px] lg:h-[500px] h-auto overflow-hidden" />
          <Card imageSrc={image5} description={description5} className="w-full sm:w-1/2 min-h-[300px] lg:h-[500px] h-auto overflow-hidden" />
        </div>
      </div>
    </div>
  );
