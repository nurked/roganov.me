...
export async function GET() {
  ...
  const lines = [
    ...
    '',
    `Ivan is available for hire for AI integration and enterprise software work through his company, Intelligent Forge Company LLC (${profile.companySite}).`,
    '',
    '## Site',
    '',
    ...
    `- [Intelligent Forge Company](${profile.companySite}/): Ivan's company — AI integration for business`,
    '',
    '## Projects',
    '',
